...
public class UnrolledCholesky_DDRM {
    ...
    public static boolean lower(DMatrix1Row A, DMatrix1Row L) {
        switch (A.numRows) {
            case 1: {
                return UnrolledCholesky_DDRM.lower1(A, L);
            }
            case 2: {
                return UnrolledCholesky_DDRM.lower2(A, L);
            }
            case 3: {
                return UnrolledCholesky_DDRM.lower3(A, L);
            }
            case 4: {
                return UnrolledCholesky_DDRM.lower4(A, L);
            }
            case 5: {
                return UnrolledCholesky_DDRM.lower5(A, L);
            }
            case 6: {
                return UnrolledCholesky_DDRM.lower6(A, L);
            }
            case 7: {
                return UnrolledCholesky_DDRM.lower7(A, L);
            }
        }
        return false;
    }
    ...
    public static boolean upper(DMatrix1Row A, DMatrix1Row L) {
        switch (A.numRows) {
            case 1: {
                return UnrolledCholesky_DDRM.upper1(A, L);
            }
            case 2: {
                return UnrolledCholesky_DDRM.upper2(A, L);
            }
            case 3: {
                return UnrolledCholesky_DDRM.upper3(A, L);
            }
            case 4: {
                return UnrolledCholesky_DDRM.upper4(A, L);
            }
            case 5: {
                return UnrolledCholesky_DDRM.upper5(A, L);
            }
            case 6: {
                return UnrolledCholesky_DDRM.upper6(A, L);
            }
            case 7: {
                return UnrolledCholesky_DDRM.upper7(A, L);
            }
        }
        return false;
    }
