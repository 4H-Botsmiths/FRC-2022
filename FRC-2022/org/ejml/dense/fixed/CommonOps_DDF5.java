...
public class CommonOps_DDF5 {
    public static void add(DMatrix5x5 a, DMatrix5x5 b, DMatrix5x5 c) {
        c.a11 = a.a11 + b.a11;
        c.a12 = a.a12 + b.a12;
        c.a13 = a.a13 + b.a13;
        c.a14 = a.a14 + b.a14;
    ...
    public static void add(DMatrix5 a, DMatrix5 b, DMatrix5 c) {
        c.a1 = a.a1 + b.a1;
        c.a2 = a.a2 + b.a2;
        c.a3 = a.a3 + b.a3;
        c.a4 = a.a4 + b.a4;
    ...
    public static void addEquals(DMatrix5x5 a, DMatrix5x5 b) {
        a.a11 += b.a11;
        a.a12 += b.a12;
        a.a13 += b.a13;
        a.a14 += b.a14;
    ...
    public static void addEquals(DMatrix5 a, DMatrix5 b) {
        a.a1 += b.a1;
        a.a2 += b.a2;
        a.a3 += b.a3;
        a.a4 += b.a4;
    ...
    public static void subtract(DMatrix5x5 a, DMatrix5x5 b, DMatrix5x5 c) {
        c.a11 = a.a11 - b.a11;
        c.a12 = a.a12 - b.a12;
        c.a13 = a.a13 - b.a13;
        c.a14 = a.a14 - b.a14;
    ...
    public static void subtract(DMatrix5 a, DMatrix5 b, DMatrix5 c) {
        c.a1 = a.a1 - b.a1;
        c.a2 = a.a2 - b.a2;
        c.a3 = a.a3 - b.a3;
        c.a4 = a.a4 - b.a4;
    ...
    public static void subtractEquals(DMatrix5x5 a, DMatrix5x5 b) {
        a.a11 -= b.a11;
        a.a12 -= b.a12;
        a.a13 -= b.a13;
        a.a14 -= b.a14;
    ...
    public static void subtractEquals(DMatrix5 a, DMatrix5 b) {
        a.a1 -= b.a1;
        a.a2 -= b.a2;
        a.a3 -= b.a3;
        a.a4 -= b.a4;
    ...
    public static void transpose(DMatrix5x5 m) {
        double tmp = m.a12;
        m.a12 = m.a21;
        m.a21 = tmp;
        tmp = m.a13;
    ...
    public static DMatrix5x5 transpose(DMatrix5x5 input, DMatrix5x5 output) {
        if (input == null) {
            input = new DMatrix5x5();
        }
    ...
    public static void mult(DMatrix5x5 a, DMatrix5x5 b, DMatrix5x5 c) {
    ...
    public static void mult(double alpha, DMatrix5x5 a, DMatrix5x5 b, DMatrix5x5 c) {
        UtilEjml.checkSameInstance(a, c);
        UtilEjml.checkSameInstance(b, c);
    ...
    public static void multTransA(DMatrix5x5 a, DMatrix5x5 b, DMatrix5x5 c) {
        UtilEjml.checkSameInstance(a, c);
        UtilEjml.checkSameInstance(b, c);
    ...
    public static void multTransA(double alpha, DMatrix5x5 a, DMatrix5x5 b, DMatrix5x5 c) {
        UtilEjml.checkSameInstance(a, c);
        UtilEjml.checkSameInstance(b, c);
    ...
    public static void multTransAB(DMatrix5x5 a, DMatrix5x5 b, DMatrix5x5 c) {
        UtilEjml.checkSameInstance(a, c);
        UtilEjml.checkSameInstance(b, c);
    ...
    public static void multTransAB(double alpha, DMatrix5x5 a, DMatrix5x5 b, DMatrix5x5 c) {
        UtilEjml.checkSameInstance(a, c);
        UtilEjml.checkSameInstance(b, c);
    ...
    public static void multTransB(DMatrix5x5 a, DMatrix5x5 b, DMatrix5x5 c) {
        UtilEjml.checkSameInstance(a, c);
        UtilEjml.checkSameInstance(b, c);
    ...
    public static void multTransB(double alpha, DMatrix5x5 a, DMatrix5x5 b, DMatrix5x5 c) {
        UtilEjml.checkSameInstance(a, c);
        UtilEjml.checkSameInstance(b, c);
    ...
    public static void multAdd(DMatrix5x5 a, DMatrix5x5 b, DMatrix5x5 c) {
        UtilEjml.checkSameInstance(a, c);
        UtilEjml.checkSameInstance(b, c);
        c.a11 += a.a11 * b.a11 + a.a12 * b.a21 + a.a13 * b.a31 + a.a14 * b.a41 + a.a15 * b.a51;
        c.a12 += a.a11 * b.a12 + a.a12 * b.a22 + a.a13 * b.a32 + a.a14 * b.a42 + a.a15 * b.a52;
    ...
    public static void multAdd(double alpha, DMatrix5x5 a, DMatrix5x5 b, DMatrix5x5 c) {
        UtilEjml.checkSameInstance(a, c);
        UtilEjml.checkSameInstance(b, c);
        c.a11 += alpha * (a.a11 * b.a11 + a.a12 * b.a21 + a.a13 * b.a31 + a.a14 * b.a41 + a.a15 * b.a51);
        c.a12 += alpha * (a.a11 * b.a12 + a.a12 * b.a22 + a.a13 * b.a32 + a.a14 * b.a42 + a.a15 * b.a52);
    ...
    public static void multAddTransA(DMatrix5x5 a, DMatrix5x5 b, DMatrix5x5 c) {
        UtilEjml.checkSameInstance(a, c);
        UtilEjml.checkSameInstance(b, c);
        c.a11 += a.a11 * b.a11 + a.a21 * b.a21 + a.a31 * b.a31 + a.a41 * b.a41 + a.a51 * b.a51;
        c.a12 += a.a11 * b.a12 + a.a21 * b.a22 + a.a31 * b.a32 + a.a41 * b.a42 + a.a51 * b.a52;
    ...
    public static void multAddTransA(double alpha, DMatrix5x5 a, DMatrix5x5 b, DMatrix5x5 c) {
        UtilEjml.checkSameInstance(a, c);
        UtilEjml.checkSameInstance(b, c);
        c.a11 += alpha * (a.a11 * b.a11 + a.a21 * b.a21 + a.a31 * b.a31 + a.a41 * b.a41 + a.a51 * b.a51);
        c.a12 += alpha * (a.a11 * b.a12 + a.a21 * b.a22 + a.a31 * b.a32 + a.a41 * b.a42 + a.a51 * b.a52);
    ...
    public static void multAddTransAB(DMatrix5x5 a, DMatrix5x5 b, DMatrix5x5 c) {
        UtilEjml.checkSameInstance(a, c);
        UtilEjml.checkSameInstance(b, c);
        c.a11 += a.a11 * b.a11 + a.a21 * b.a12 + a.a31 * b.a13 + a.a41 * b.a14 + a.a51 * b.a15;
        c.a12 += a.a11 * b.a21 + a.a21 * b.a22 + a.a31 * b.a23 + a.a41 * b.a24 + a.a51 * b.a25;
    ...
    public static void multAddTransAB(double alpha, DMatrix5x5 a, DMatrix5x5 b, DMatrix5x5 c) {
        UtilEjml.checkSameInstance(a, c);
        UtilEjml.checkSameInstance(b, c);
        c.a11 += alpha * (a.a11 * b.a11 + a.a21 * b.a12 + a.a31 * b.a13 + a.a41 * b.a14 + a.a51 * b.a15);
        c.a12 += alpha * (a.a11 * b.a21 + a.a21 * b.a22 + a.a31 * b.a23 + a.a41 * b.a24 + a.a51 * b.a25);
    ...
    public static void multAddTransB(DMatrix5x5 a, DMatrix5x5 b, DMatrix5x5 c) {
        UtilEjml.checkSameInstance(a, c);
        UtilEjml.checkSameInstance(b, c);
        c.a11 += a.a11 * b.a11 + a.a12 * b.a12 + a.a13 * b.a13 + a.a14 * b.a14 + a.a15 * b.a15;
        c.a12 += a.a11 * b.a21 + a.a12 * b.a22 + a.a13 * b.a23 + a.a14 * b.a24 + a.a15 * b.a25;
    ...
    public static void multAddTransB(double alpha, DMatrix5x5 a, DMatrix5x5 b, DMatrix5x5 c) {
        UtilEjml.checkSameInstance(a, c);
        UtilEjml.checkSameInstance(b, c);
        c.a11 += alpha * (a.a11 * b.a11 + a.a12 * b.a12 + a.a13 * b.a13 + a.a14 * b.a14 + a.a15 * b.a15);
        c.a12 += alpha * (a.a11 * b.a21 + a.a12 * b.a22 + a.a13 * b.a23 + a.a14 * b.a24 + a.a15 * b.a25);
    ...
    public static void mult(DMatrix5x5 a, DMatrix5 b, DMatrix5 c) {
    ...
    public static void mult(DMatrix5 a, DMatrix5x5 b, DMatrix5 c) {
    ...
    public static double dot(DMatrix5 a, DMatrix5 b) {
        return a.a1 * b.a1 + a.a2 * b.a2 + a.a3 * b.a3 + a.a4 * b.a4 + a.a5 * b.a5;
    }

    public static void setIdentity(DMatrix5x5 a) {
        a.a11 = 1.0;
        a.a21 = 0.0;
        a.a31 = 0.0;
        a.a41 = 0.0;
    ...
    public static boolean invert(DMatrix5x5 a, DMatrix5x5 inv) {
        double scale = 1.0 / CommonOps_DDF5.elementMaxAbs(a);
    ...
    public static double det(DMatrix5x5 mat) {
        ...
        a34 = mat.a44;
        a44 = mat.a54;
        return ret += mat.a15 * (a11 * (a22 * (a33 * a44 - a34 * a43) - a23 * (a32 * a44 - a34 * a42) + a24 * (a32 * a43 - a33 * a42)) - a12 * (a21 * (a33 * a44 - a34 * a43) - a23 * (a31 * a44 - a34 * a41) + a24 * (a31 * a43 - a33 * a41)) + a13 * (a21 * (a32 * a44 - a34 * a42) - a22 * (a31 * a44 - a34 * a41) + a24 * (a31 * a42 - a32 * a41)) - a14 * (a21 * (a32 * a43 - a33 * a42) - a22 * (a31 * a43 - a33 * a41) + a23 * (a31 * a42 - a32 * a41)));
    }
    ...
    public static double elementMax(DMatrix5x5 a) {
        double max = a.a11;
        if (a.a12 > max) {
            max = a.a12;
        }
    ...
    public static double elementMax(DMatrix5 a) {
        double max = a.a1;
        if (a.a2 > max) {
            max = a.a2;
        }
    ...
    public static double elementMaxAbs(DMatrix5x5 a) {
    ...
    public static double elementMaxAbs(DMatrix5 a) {
    ...
    public static double elementMin(DMatrix5x5 a) {
        double min = a.a11;
        if (a.a12 < min) {
            min = a.a12;
        }
    ...
    public static double elementMin(DMatrix5 a) {
        double min = a.a1;
        if (a.a2 < min) {
            min = a.a2;
        }
    ...
    public static double elementMinAbs(DMatrix5x5 a) {
    ...
    public static double elementMinAbs(DMatrix5 a) {
    ...
    public static void elementMult(DMatrix5 a, DMatrix5 b) {
        a.a1 *= b.a1;
        a.a2 *= b.a2;
        a.a3 *= b.a3;
        a.a4 *= b.a4;
    ...
    public static void elementMult(DMatrix5x5 a, DMatrix5x5 b, DMatrix5x5 c) {
        c.a11 = a.a11 * b.a11;
        c.a12 = a.a12 * b.a12;
        c.a13 = a.a13 * b.a13;
        c.a14 = a.a14 * b.a14;
    ...
    public static void elementMult(DMatrix5 a, DMatrix5 b, DMatrix5 c) {
        c.a1 = a.a1 * b.a1;
        c.a2 = a.a2 * b.a2;
        c.a3 = a.a3 * b.a3;
        c.a4 = a.a4 * b.a4;
    ...
    public static void elementDiv(DMatrix5x5 a, DMatrix5x5 b) {
        a.a11 /= b.a11;
        a.a12 /= b.a12;
        a.a13 /= b.a13;
        a.a14 /= b.a14;
    ...
    public static void elementDiv(DMatrix5 a, DMatrix5 b) {
        a.a1 /= b.a1;
        a.a2 /= b.a2;
        a.a3 /= b.a3;
        a.a4 /= b.a4;
    ...
    public static void elementDiv(DMatrix5x5 a, DMatrix5x5 b, DMatrix5x5 c) {
        c.a11 = a.a11 / b.a11;
        c.a12 = a.a12 / b.a12;
        c.a13 = a.a13 / b.a13;
        c.a14 = a.a14 / b.a14;
    ...
    public static void elementDiv(DMatrix5 a, DMatrix5 b, DMatrix5 c) {
        c.a1 = a.a1 / b.a1;
        c.a2 = a.a2 / b.a2;
        c.a3 = a.a3 / b.a3;
        c.a4 = a.a4 / b.a4;
    ...
    public static void changeSign(DMatrix5x5 a) {
        a.a11 = -a.a11;
        a.a12 = -a.a12;
        a.a13 = -a.a13;
        a.a14 = -a.a14;
    ...
    public static void changeSign(DMatrix5 a) {
        a.a1 = -a.a1;
        a.a2 = -a.a2;
        a.a3 = -a.a3;
        a.a4 = -a.a4;
    ...
    public static DMatrix5 extractColumn(DMatrix5x5 a, int column, DMatrix5 out) {
        if (out == null) {
            out = new DMatrix5();
        }
        switch (column) {
