...
public class UnrolledCholesky_FDRM {
    ...
    public static boolean lower(FMatrix1Row A, FMatrix1Row L) {
        switch (A.numRows) {
            case 1: {
                return UnrolledCholesky_FDRM.lower1(A, L);
            }
            case 2: {
                return UnrolledCholesky_FDRM.lower2(A, L);
            }
            case 3: {
                return UnrolledCholesky_FDRM.lower3(A, L);
            }
            case 4: {
                return UnrolledCholesky_FDRM.lower4(A, L);
            }
            case 5: {
                return UnrolledCholesky_FDRM.lower5(A, L);
            }
            case 6: {
                return UnrolledCholesky_FDRM.lower6(A, L);
            }
            case 7: {
                return UnrolledCholesky_FDRM.lower7(A, L);
            }
        }
        return false;
    }
    ...
    public static boolean upper(FMatrix1Row A, FMatrix1Row L) {
        switch (A.numRows) {
            case 1: {
                return UnrolledCholesky_FDRM.upper1(A, L);
            }
            case 2: {
                return UnrolledCholesky_FDRM.upper2(A, L);
            }
            case 3: {
                return UnrolledCholesky_FDRM.upper3(A, L);
            }
            case 4: {
                return UnrolledCholesky_FDRM.upper4(A, L);
            }
            case 5: {
                return UnrolledCholesky_FDRM.upper5(A, L);
            }
            case 6: {
                return UnrolledCholesky_FDRM.upper6(A, L);
            }
            case 7: {
                return UnrolledCholesky_FDRM.upper7(A, L);
            }
        }
        return false;
    }
