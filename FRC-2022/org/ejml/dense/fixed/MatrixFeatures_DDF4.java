...
public class MatrixFeatures_DDF4 {
    public static boolean isIdentical(DMatrix4x4 a, DMatrix4x4 b, double tol) {
    ...
    public static boolean isIdentical(DMatrix4 a, DMatrix4 b, double tol) {
    ...
    public static boolean hasUncountable(DMatrix4x4 a) {
    ...
    public static boolean hasUncountable(DMatrix4 a) {
