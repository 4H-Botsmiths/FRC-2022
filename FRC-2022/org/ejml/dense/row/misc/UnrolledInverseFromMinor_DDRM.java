...
public class UnrolledInverseFromMinor_DDRM {
    ...
    public static void inv(DMatrixRMaj mat, DMatrixRMaj inv) {
        ...
        switch (mat.numRows) {
            case 2: {
                UnrolledInverseFromMinor_DDRM.inv2(mat, inv, 1.0 / max);
                break;
            }
            case 3: {
                UnrolledInverseFromMinor_DDRM.inv3(mat, inv, 1.0 / max);
                break;
            }
            case 4: {
                UnrolledInverseFromMinor_DDRM.inv4(mat, inv, 1.0 / max);
                break;
            }
            case 5: {
                UnrolledInverseFromMinor_DDRM.inv5(mat, inv, 1.0 / max);
                break;
            }
            default: {
