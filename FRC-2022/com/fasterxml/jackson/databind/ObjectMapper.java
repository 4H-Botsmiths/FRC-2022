...
Serializable {
    ...
    public ObjectMapper configure(MapperFeature f, boolean state) {
        SerializationConfig serializationConfig = state ? (SerializationConfig)this._serializationConfig.with(new MapperFeature[]{f}) : (this._serializationConfig = (SerializationConfig)this._serializationConfig.without(new MapperFeature[]{f}));
