...
public class ImplMultiplication_MT_DSCC {
    public static void mult(DMatrixSparseCSC A, DMatrixSparseCSC B, DMatrixSparseCSC C, GrowArray<Workspace_MT_DSCC> listWork) {
        EjmlConcurrency.loopBlocks(0, B.numCols, listWork, (workspace, bj0, bj1) -> {
            ...
            for (int bj = bj0; bj < bj1; ++bj) {
                ...
                for (int bi = idx0; bi < idx1; ++bi) {
                    ...
                    ImplMultiplication_DSCC.multAddColA(A, rowB, valB, workC, colC + 1, x, w);
                }
        ...
        ImplMultiplication_MT_DSCC.stitchMatrix(C, A.numRows, B.numCols, listWork);
    }

    public static void stitchMatrix(DMatrixSparseCSC out, int numRows, int numCols, GrowArray<Workspace_MT_DSCC> listWork) {
        int i;
    ...
    public static void mult(DMatrixSparseCSC A, DMatrixRMaj B, DMatrixRMaj C, GrowArray<DGrowArray> listWork) {
        ImplMultiplication_MT_DSCC.mult(A, B, C, false, listWork);
    }

    public static void multAdd(DMatrixSparseCSC A, DMatrixRMaj B, DMatrixRMaj C, GrowArray<DGrowArray> listWork) {
        ImplMultiplication_MT_DSCC.mult(A, B, C, true, listWork);
    }

    public static void mult(DMatrixSparseCSC A, DMatrixRMaj B, DMatrixRMaj C, boolean add, GrowArray<DGrowArray> listWork) {
        EjmlConcurrency.loopBlocks(0, B.numCols, listWork, (gwork, bj0, bj1) -> {
            double[] work = gwork.reshape((int)(A.numRows + B.numRows)).data;
            for (int bj = bj0; bj < bj1; ++bj) {
                int rowC;
                int k;
    ...
    public static void multTransA(DMatrixSparseCSC A, DMatrixRMaj B, DMatrixRMaj C, GrowArray<DGrowArray> listWork) {
        EjmlConcurrency.loopBlocks(0, B.numCols, listWork, (gwork, j0, j1) -> {
            double[] work = gwork.reshape((int)B.numRows).data;
            for (int j = j0; j < j1; ++j) {
    ...
    public static void multAddTransA(DMatrixSparseCSC A, DMatrixRMaj B, DMatrixRMaj C, GrowArray<DGrowArray> listWork) {
        EjmlConcurrency.loopBlocks(0, B.numCols, listWork, (gwork, j0, j1) -> {
            double[] work = gwork.reshape((int)B.numRows).data;
            for (int j = j0; j < j1; ++j) {
                for (int k = 0; k < B.numRows; ++k) {
    ...
    public static void multTransB(DMatrixSparseCSC A, DMatrixRMaj B, DMatrixRMaj C, GrowArray<DGrowArray> listWork) {
        ImplMultiplication_MT_DSCC.multTransB(A, B, C, false, listWork);
    }

    public static void multAddTransB(DMatrixSparseCSC A, DMatrixRMaj B, DMatrixRMaj C, GrowArray<DGrowArray> listWork) {
        ImplMultiplication_MT_DSCC.multTransB(A, B, C, true, listWork);
    }

    public static void multTransB(DMatrixSparseCSC A, DMatrixRMaj B, DMatrixRMaj C, boolean add, GrowArray<DGrowArray> listWork) {
        EjmlConcurrency.loopBlocks(0, B.numRows, listWork, (gwork, bj0, bj1) -> {
            double[] work = gwork.reshape((int)A.numRows).data;
            for (int bj = bj0; bj < bj1; ++bj) {
                int rowC;
                Arrays.fill(work, 0, A.numRows, 0.0);
