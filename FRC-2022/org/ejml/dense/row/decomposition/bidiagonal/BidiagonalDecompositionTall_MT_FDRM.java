...
implements BidiagonalDecomposition_F32<FMatrixRMaj> {
    ...
    BidiagonalDecomposition_F32<FMatrixRMaj> decompBi = new BidiagonalDecompositionRow_MT_FDRM();
    ...
    public FMatrixRMaj getU(@Nullable FMatrixRMaj U, boolean transpose, boolean compact) {
        ...
        if (compact) {
            ...
            CommonOps_MT_FDRM.mult(Q1, U1, U);
        } else {
            ...
            CommonOps_MT_FDRM.mult(Q1, U1, tmp);
    ...
    public boolean decompose(FMatrixRMaj orig) {
        ...
        CommonOps_MT_FDRM.multTransB(this.B, P, result);
        this.B.setTo(result);
