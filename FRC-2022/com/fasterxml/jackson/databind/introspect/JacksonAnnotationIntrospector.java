...
implements Serializable {
    ...
    public JavaType refineSerializationType(MapperConfig<?> config, Annotated a, JavaType baseType) throws JsonMappingException {
        ...
        block26: {
            ...
            Class<?> class_ = serClass = jsonSer == null ? null : this._classIfExplicit(jsonSer.as());
            if (serClass != null) {
        ...
        if (type.isMapLikeType()) {
            ...
            Class<?> class_ = keyClass = jsonSer == null ? null : this._classIfExplicit(jsonSer.keyAs());
            if (keyClass != null) {
                block27: {
        ...
        if ((contentType = type.getContentType()) != null) {
            Class<?> contentClass;
            Class<?> class_ = contentClass = jsonSer == null ? null : this._classIfExplicit(jsonSer.contentAs());
    ...
    public JavaType refineDeserializationType(MapperConfig<?> config, Annotated a, JavaType baseType) throws JsonMappingException {
        ...
        Class<?> class_ = valueClass = jsonDeser == null ? null : this._classIfExplicit(jsonDeser.as());
        ...
        if (type.isMapLikeType()) {
            Class<?> keyClass;
            JavaType keyType = type.getKeyType();
            Class<?> class_2 = keyClass = jsonDeser == null ? null : this._classIfExplicit(jsonDeser.keyAs());
        ...
        if ((contentType = type.getContentType()) != null) {
            Class<?> contentClass;
            Class<?> class_3 = contentClass = jsonDeser == null ? null : this._classIfExplicit(jsonDeser.contentAs());
