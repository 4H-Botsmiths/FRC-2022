...
extends JNIWrapper {
    ...
    public static native int registerReadAutoReceiveBufferCallback(int var0, SpiReadAutoReceiveBufferCallback var1);

    public static native void cancelReadAutoReceiveBufferCallback(int var0, int var1);
