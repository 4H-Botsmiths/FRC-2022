...
extends CollectorBase {
    ...
    private List<AnnotatedMethod> _findPotentialFactories(TypeFactory typeFactory, JavaType type, Class<?> primaryMixIn) {
        ...
        TypeResolutionContext.Empty emptyTypeResCtxt = new TypeResolutionContext.Empty(typeFactory);
        ...
        if (primaryMixIn != null) {
            ...
            block2: for (Method mixinFactory : primaryMixIn.getDeclaredMethods()) {
                ...
                for (int i = 0; i < factoryCount; ++i) {
                    ...
                    result.set(i, this.constructFactoryCreator((Method)candidates.get(i), emptyTypeResCtxt, mixinFactory));
                    continue block2;
                }
            }
        }
        for (int i = 0; i < factoryCount; ++i) {
            ...
            TypeResolutionContext typeResCtxt = MethodGenericTypeResolver.narrowMethodTypeParameters(candidate, type, typeFactory, emptyTypeResCtxt);
