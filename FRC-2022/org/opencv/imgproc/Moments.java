...
public class Moments {
    ...
    public void set(double[] vals) {
        if (vals != null) {
            this.m00 = vals.length > 0 ? vals[0] : 0.0;
            this.m10 = vals.length > 1 ? vals[1] : 0.0;
            this.m01 = vals.length > 2 ? vals[2] : 0.0;
            this.m20 = vals.length > 3 ? vals[3] : 0.0;
            this.m11 = vals.length > 4 ? vals[4] : 0.0;
            this.m02 = vals.length > 5 ? vals[5] : 0.0;
            this.m30 = vals.length > 6 ? vals[6] : 0.0;
            this.m21 = vals.length > 7 ? vals[7] : 0.0;
            this.m12 = vals.length > 8 ? vals[8] : 0.0;
            this.m03 = vals.length > 9 ? vals[9] : 0.0;
            this.completeState();
        } else {
            this.m00 = 0.0;
            this.m10 = 0.0;
    ...
    protected void completeState() {
        ...
        double mu20 = this.m20 - this.m10 * cx;
        double mu11 = this.m11 - this.m10 * cy;
        double mu02 = this.m02 - this.m01 * cy;
        this.mu20 = mu20;
        this.mu11 = mu11;
        this.mu02 = mu02;
        this.mu30 = this.m30 - cx * (3.0 * mu20 + cx * this.m10);
        mu11 += mu11;
        this.mu21 = this.m21 - cx * (mu11 + cx * this.m01) - cy * mu20;
        this.mu12 = this.m12 - cy * (mu11 + cy * this.m10) - cx * mu02;
        this.mu03 = this.m03 - cy * (3.0 * mu02 + cy * this.m01);
