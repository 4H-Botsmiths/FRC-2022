...
public class DConvertMatrixStruct {
    ...
    public static DMatrixSparseCSC convert(DMatrixSparseTriplet src, @Nullable DMatrixSparseCSC dst, @Nullable IGrowArray histStorage) {
        int i;
    ...
    public static DMatrixSparseCSC convert(DMatrixSparseTriplet src, @Nullable DMatrixSparseCSC dst) {
        return DConvertMatrixStruct.convert(src, dst, null);
    }
